...
import com.alpha.manager.MsgManager;
...
/**
 * Created by taoxiang on 2017/5/11.
 */
...
public class MsgManagerImpl implements MsgManager {
     ...
     */
    @Override
    public boolean sendCodeMsg(String phoneNumber) {
        Map<String, Object> paramStringMap = new HashMap<String, Object>();
        paramStringMap.put("code",  getRandNum() + "");
        return sendCodeMsg(phoneNumber, JSON.toJSONString(paramStringMap), "SMS_66990041");
    }

    public boolean sendAccountOpenMsg(SystemAccountDO systemAccountDO) {
        Map<String, Object> paramStringMap = new HashMap<String, Object>();
    ...
    private boolean sendCodeMsg(String phoneNumber, String paramString, String templateCode) {
        ...
        try {
            ...
            System.out.println("http=" + JSON.toJSONString(jsonObject));
